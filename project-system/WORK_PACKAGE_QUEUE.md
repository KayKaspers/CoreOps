...
| CO-WP-004B1| transfer-preparation | First NDF Feedback Transfer Package                        | implemented-awaiting-nova-review|
...
- Nur `CO-WP-004C` ist der nächste geplante Schritt (`planned-next`).
