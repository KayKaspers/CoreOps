...
| CO-WP-004C| docs-only         | BSI and Public-Sector Readiness Baseline                       | implemented-awaiting-nova-review|
| CO-WP-004D| gov-baseline      | ITIL and PRINCE2 Applicability and Tailoring Decision          | planned-next                    |
...
- Nur `CO-WP-004D` ist der nächste geplante Schritt (`planned-next`).
