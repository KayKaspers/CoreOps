...
| CO-WP-009 | security-baseline | Human Identity, Workspaces, RBAC and Break Glass               | implemented-awaiting-nova-review|
| CO-WP-010 | security-baseline | Machine Identity, Enrollment and Offline Credential Lifecycle  | planned-next                  |
...
- Nur `CO-WP-010` ist der nächste geplante Schritt (`planned-next`).
