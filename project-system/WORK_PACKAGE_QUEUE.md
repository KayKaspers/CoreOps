...
| CO-WP-019 | docs-only         | Telemetry and Normalization Schema                             | implemented-awaiting-nova-review|
| CO-WP-020 | docs-only         | Topology Graph, Evidence and Manual Authority                  | planned-next                  |
...
- Nur `CO-WP-020` ist der nächste geplante Schritt (`planned-next`). `CO-WP-019` ist `implemented-awaiting-nova-review` und wird erst nach Nova Review und Human-Maintainer-Commit als abgeschlossen geführt.
