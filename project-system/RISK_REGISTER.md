...
| RISK-14 | Release-Taxonomie-Mehrdeutigkeit | `Foundation 0.1` vs. `Release 0.1 – Observe` | planning | high | medium | medium | vorläufige Kennzeichnung in ROADMAP/NEXT_PHASE | Verbindliche Release-Taxonomie (CCR-02) | HM | CO-WP-003 | open | Concept §49 |
...
| RISK-17 | NDF-Level-Ambiguität | `ndf_level:1` vs. Starter-Vorlage `2` als Reifeaussage missverstanden | governance | medium | low | low | offen dokumentiert in Manifest/Profile/Brain | Klärung NDF-Level (CCR-03) | HM | CO-WP-005 | open | Manifest, CO-WP-001 |
...
- medium: 9 (RISK-06, 07, 10, 12, 13, 14, 15, 16, 18)
- low: 1 (RISK-17)
