...
| DEC-O-02 | Release-Taxonomie / SemVer / 0.1-Kollision | clarified | CCR | §49 | HM | CO-WP-003 | nein | CCR-02 aufgelöst in RELEASE_TAXONOMY.md (Accepted, HM-1); Tag-Kandidaten `v0.0.1-foundation`, `v0.1.0-alpha.1` |
...
| DEC-O-04 | `main`-Normativität (Concept vs. Governance) | binding-governance | BG | §Ausgangskontext | HM | CO-WP-003 | nein | CCR-04 geklärt: `v1.0.0`/`9dcadc1` normativ, `main` informativ; Übernahme nur via eigenes WP |
...
| DEC-O-10 | Docker-first: Anforderung/Baseline/Architektur/Kandidat | clarified | APC | §3,§53 | HM | CO-WP-003 | nein | CCR-10 eingeordnet: akzeptierte Delivery-/Betriebsanforderung (Compose-Standardinstallation), keine Anwendungsarchitektur, kein K8s-Zwang; noch nicht implementiert |
| DEC-O-11 | Foundation-Queue-Autorität (Concept §50 vs. aktive Queue) | clarified | CCR | §50 | Nova | CO-WP-003 | nein | CCR-11 geklärt: aktive Queue ausschließlich WORK_PACKAGE_QUEUE.md; Concept-Queue historischer Vorschlag |
...
| DEC-O-12 | Herstellersupport-Grenze | clarified | APC/CCR | §18,§26,§27 | Nova | CO-WP-004 | nein | CCR-12 vorgeschlagen aufgelöst in INITIAL_SUPPORT_BOUNDARY.md: Nennung = Kandidat, kein Support/Partnerschaft/Zertifizierung |
| DEC-O-13 | Source-of-Truth-Konfliktprioritäten je Datenklasse | open | FR/AC | §19 | Nova | CO-WP-011 | ja (ADR-0009) | — |
| DEC-O-17 | Foundation Capability Matrix | clarified | — | CO-WP-004 | Nova | CO-WP-004 | nein | Planungs-/Governance-Landkarte; 94 Capabilities, alle not-implemented/not-supported (Zählkorrektur CO-WP-004E; in CO-WP-004 seinerzeit als „74" ausgewiesen) |
| DEC-O-18 | Initial Observe Support Boundary | clarified | — | CO-WP-004 | HM | CO-WP-004 | nein | Observe read-only bis Level 2; Write ausgeschlossen |
| DEC-O-19 | Drei getrennte Statusdimensionen | binding-governance | BG | CO-WP-004 | Nova | CO-WP-004 | nein | Roadmap/Implementation/Support unabhängig |
| DEC-O-20 | Support-Evidence-Anforderungen | binding-governance | BG | CO-WP-004 | Nova | CO-WP-004 | nein | 21-Punkte-Evidence-Satz; ohne Evidenz max. experimental |
| DEC-O-21 | Herstellerlisten sind keine Supportzusage | binding-governance | BG | CO-WP-004 | Nova | CO-WP-004 | nein | Vendor priority ≠ vendor support |
...
## Deployment Control Plane Decisions (CO-WP-021)

> Registriert über [DEPLOYMENT_CONTROL_PLANE_AND_EXECUTION_MODEL.md](../docs/architecture/DEPLOYMENT_CONTROL_PLANE_AND_EXECUTION_MODEL.md), [DEPLOYMENT_BLUEPRINT_VERSIONING_AND_COMPATIBILITY_MODEL.md](../docs/architecture/DEPLOYMENT_BLUEPRINT_VERSIONING_AND_COMPATIBILITY_MODEL.md) und [DEPLOYMENT_TARGETING_EXECUTION_AND_RECOVERY_POLICY.md](../docs/security/DEPLOYMENT_TARGETING_EXECUTION_AND_RECOVERY_POLICY.md). **Getrennte Dimensionen** (Decision Class · Lifecycle Status · Binding Level); keine kombinierten Pseudostatuswerte; keine Deployment-Engine-/Orchestrator-/Pipeline-/Blueprint-Format-/Schema-/Agent-/Registry-/Rollback-Technologie ausgewählt; keine ADR.

| Decision ID | Topic | Decision Class | Lifecycle Status | Binding Level | Source | Owner | Notes |
| ----------- | ----- | -------------- | ---------------- | ------------- | ------ | ----- | ----- |
| DEC-S-274 | Deployment control plane | architecture-context | accepted | binding-governance | CO-WP-021 | Nova | Governance-/Koordinationsgrenze; ≠ Deployment-Runtime |
| DEC-S-275 | Blueprint identity | governance-direction | accepted | binding-governance | CO-WP-021 | Nova | Stabil; ≠ file name/repository path/product version |
| DEC-S-276 | Deployment responsibilities | security-context | accepted | binding-governance | CO-WP-021 | Nova | Blueprint/Intent/Plan/Approval/Execution Authorization/Execution/Verification/Closure getrennt |
| DEC-S-277 | Dynamic topology selection | security-context | accepted | binding-governance | CO-WP-021 | Nova | Materialisierung in begrenzten Target-Set-Snapshot |
| DEC-S-278 | Target-set approval validity | security-context | accepted | binding-governance | CO-WP-021 | Nova | Re-Evaluation nach materieller Target-/Topology-Änderung |
| DEC-S-279 | Blueprint parameters/overlays | security-context | accepted | binding-governance | CO-WP-021 | Nova | Provenance erhalten; schwächen Security **nicht** still |
| DEC-S-280 | Artifact availability | security-context | accepted | binding-governance | CO-WP-021 | Nova | ≠ Trust/Integrität/Compatibility/Authorization |
| DEC-S-281 | Deployment execution semantics | governance-direction | accepted | binding-governance | CO-WP-021 | Nova | Execution ≠ desired-state verification |
| DEC-S-282 | Waves | security-context | accepted | binding-governance | CO-WP-021 | Nova | Explizite Target-Subsets/Entry-Conditions/Expansion-Entscheidung |
| DEC-S-283 | Partial/unknown per-target results | security-context | accepted | binding-governance | CO-WP-021 | Nova | Sichtbar; blockieren unsafe automatischen Retry |
| DEC-S-284 | Cancellation semantics | governance-direction | accepted | binding-governance | CO-WP-021 | Nova | ≠ Abwesenheit von Nebenwirkungen |
| DEC-S-285 | Rollback | security-context | accepted | binding-governance | CO-WP-021 | HM | Gebundene Autorität + Verifikationsevidenz |
| DEC-S-286 | Machine principals in deployment | security-context | accepted | binding-governance | CO-WP-021 | Nova | Imitieren keine Human Approval/Manual Authority |
| DEC-S-287 | Offline deployment | security-context | accepted | binding-governance | CO-WP-021 | Nova | Provenance, Integrität, Target-Binding, gebundene Authorization, explizite Aktivierung |
| DEC-S-288 | Deployment engine/orchestrator/pipeline/blueprint-format/schema/agent-protocol/registry/rollback technology | architecture-context | deferred | non-binding | CO-WP-021 | Nova | Deferred |

## Artifact Trust and Supply-Chain Decisions (CO-WP-022)

> Registriert über [ARTIFACT_IDENTITY_PROVENANCE_AND_SBOM_MODEL.md](../docs/architecture/ARTIFACT_IDENTITY_PROVENANCE_AND_SBOM_MODEL.md), [ARTIFACT_DEPENDENCY_COMPATIBILITY_AND_DISTRIBUTION_MODEL.md](../docs/architecture/ARTIFACT_DEPENDENCY_COMPATIBILITY_AND_DISTRIBUTION_MODEL.md) und [ARTIFACT_TRUST_QUARANTINE_AND_REVOCATION_POLICY.md](../docs/security/ARTIFACT_TRUST_QUARANTINE_AND_REVOCATION_POLICY.md). **Getrennte Dimensionen** (Decision Class · Lifecycle Status · Binding Level); keine kombinierten Pseudostatuswerte; keine Registry-/Package-/SBOM-/Hash-/Signing-/Trust-Anchor-/Transparency-/Scanner-/Build-/Dependency-Resolution-Technologie ausgewählt; keine ADR; keine Wiederholung bestehender Cross-Foundation-Invarianten.

| Decision ID | Topic | Decision Class | Lifecycle Status | Binding Level | Source | Owner | Notes |
| ----------- | ----- | -------------- | ---------------- | ------------- | ------ | ----- | ----- |
| DEC-S-289 | Artifact identity | governance-direction | accepted | binding-governance | CO-WP-022 | Nova | Stabil; ≠ file name/repository path/alias |
| DEC-S-290 | Artifact version/revision/instance dimensions | governance-direction | accepted | binding-governance | CO-WP-022 | Nova | Version/Revision/Build-/Distribution-/Deployment-Instance getrennt |
| DEC-S-291 | Mutable artifact alias | security-context | accepted | binding-governance | CO-WP-022 | Nova | Nicht ausreichend als finale privilegierte Deployment-Bindung |
| DEC-S-292 | Artifact roles | security-context | accepted | binding-governance | CO-WP-022 | Nova | Source/Producer/Builder/Distributor/Repository-Operator/Validator/Trust-Owner getrennt |
| DEC-S-293 | Trust dimensions | security-context | accepted | binding-governance | CO-WP-022 | Nova | Provenance/Integrity/Validation/Trust/Support/Compatibility getrennt |
| DEC-S-294 | SBOM dimensions | security-context | accepted | binding-governance | CO-WP-022 | Nova | Availability/Freshness/Completeness/Accuracy/Validation getrennt |
| DEC-S-295 | Component identity | security-context | accepted | binding-governance | CO-WP-022 | Nova | Nicht durch Display Name/Version Label allein etabliert |
| DEC-S-296 | Vulnerability reference | security-context | accepted | binding-governance | CO-WP-022 | Nova | Impliziert **nicht** automatisch Artifact-/Deployment-Exploitability |
| DEC-S-297 | Trust decision | security-context | accepted | binding-governance | CO-WP-022 | Nova | Use-/target-/scope-/version-/time-bound; ≠ Execution Authorization |
| DEC-S-298 | Quarantine release | security-context | accepted | binding-governance | CO-WP-022 | Nova | Impliziert **keine** Deployment Authorization |
| DEC-S-299 | Withdrawal/revocation/removal states | security-context | accepted | binding-governance | CO-WP-022 | Nova | Withdrawal/Revocation/Repository-Removal/Support-Withdrawal getrennt |
| DEC-S-300 | Revocation effect | security-context | accepted | binding-governance | CO-WP-022 | HM | Blockiert neues Deployment außer bei expliziter governter Exception |
| DEC-S-301 | Reinstatement | security-context | accepted | binding-governance | CO-WP-022 | Nova | Erhält Revocation-Historie; ≠ globaler Trust |
| DEC-S-302 | Offline artifact transfer | security-context | accepted | binding-governance | CO-WP-022 | Nova | Provenance, Integrität, Target-Binding, gebundener Trust, explizite Import-Governance |
| DEC-S-303 | Artifact-registry/package-format/SBOM-format/hash/signing/trust-anchor/transparency-log/scanner/build/dependency-resolution technology | architecture-context | deferred | non-binding | CO-WP-022 | Nova | Deferred |

## Restricted Operation, Offline Distribution and CorePack Decisions (CO-WP-023)

> Registriert über [RESTRICTED_ISOLATED_AND_AIR_GAPPED_OPERATION_MODEL.md](../docs/architecture/RESTRICTED_ISOLATED_AND_AIR_GAPPED_OPERATION_MODEL.md), [COREPACK_IDENTITY_CONTENT_AND_LIFECYCLE_MODEL.md](../docs/architecture/COREPACK_IDENTITY_CONTENT_AND_LIFECYCLE_MODEL.md) und [OFFLINE_TRUST_ACTIVATION_REVOCATION_AND_TRANSFER_POLICY.md](../docs/security/OFFLINE_TRUST_ACTIVATION_REVOCATION_AND_TRANSFER_POLICY.md). **Getrennte Dimensionen** (Decision Class · Lifecycle Status · Binding Level); keine kombinierten Pseudostatuswerte; keine Package-/Manifest-/Installer-/Update-/Transfer-/Hash-/Signing-/Trust-Anchor-/Encryption-/Reconciliation-Technologie ausgewählt; keine ADR; keine Wiederholung bestehender Cross-Foundation-Invarianten.

| Decision ID | Topic | Decision Class | Lifecycle Status | Binding Level | Source | Owner | Notes |
| ----------- | ----- | -------------- | ---------------- | ------------- | ------ | ----- | ----- |
| DEC-S-304 | Operational connectivity classes | governance-direction | accepted | binding-governance | CO-WP-023 | Nova | connected/restricted-connected/intermittently-connected/isolated/air-gapped/recovery-only getrennte Betriebsbedingungen; keine Klassifiziertnetz-Eignung |
| DEC-S-305 | Offline operation authority | security-context | accepted | binding-governance | CO-WP-023 | HM | Erweitert zentrale/lokale Autorität **nicht** automatisch |
| DEC-S-306 | CorePack boundary | governance-direction | accepted | binding-governance | CO-WP-023 | Nova | Governte Distributionseinheit; ≠ Domain Pack/Artifact/Deployment Blueprint/Backup/Evidence Package |
| DEC-S-307 | CorePack identity/version/revision/instances | governance-direction | accepted | binding-governance | CO-WP-023 | Nova | Identity/Version/Revision/Assembly-/Transfer-/Import-/Activation-Instance getrennt |
| DEC-S-308 | CorePack lifecycle states | security-context | accepted | binding-governance | CO-WP-023 | Nova | Transfer/Receipt/Import/Trust/Approval/Activation getrennte Zustände |
| DEC-S-309 | CorePack content trust inheritance | security-context | accepted | binding-governance | CO-WP-023 | Nova | Contents erben Trust/Validation/Compatibility **nicht** vom Container |
| DEC-S-310 | CorePack target binding | security-context | accepted | binding-governance | CO-WP-023 | Nova | Durch Transfer/Import/Activation erhalten; nicht durch lokalen Rename ersetzbar |
| DEC-S-311 | CorePack quarantine release | security-context | accepted | binding-governance | CO-WP-023 | Nova | Impliziert **keine** Activation Authorization |
| DEC-S-312 | Delta activation | security-context | accepted | binding-governance | CO-WP-023 | Nova | Erfordert bestätigte exakte Ausgangsrevision |
| DEC-S-313 | Delayed revocation | security-context | accepted | binding-governance | CO-WP-023 | HM | Bleibt explizit; kann neue Activation beschränken/blockieren |
| DEC-S-314 | Offline authorization | security-context | accepted | binding-governance | CO-WP-023 | Nova | Action-/target-/scope-/version-/purpose-/time-bound; nicht wiederverwendbar |
| DEC-S-315 | CorePack rollback | security-context | accepted | binding-governance | CO-WP-023 | Nova | Erfordert aktuelle Trust-/Revocation-/Compatibility-/Recovery-Bewertung |
| DEC-S-316 | Restricted/degraded operation | security-context | accepted | binding-governance | CO-WP-023 | Nova | Benannt, begrenzt, zurechenbar, reviewbar; kein Autoritätszuwachs |
| DEC-S-317 | CorePack format/manifest/installer/update/transfer/hash/signing/trust-anchor/encryption/reconciliation technology | architecture-context | deferred | non-binding | CO-WP-023 | Nova | Deferred |

## Secrets, Configuration Vault and Key Custody Decisions (CO-WP-024)

> Registriert über [SECRETS_CONFIGURATION_VAULT_AND_CUSTODY_GOVERNANCE.md](../docs/security/SECRETS_CONFIGURATION_VAULT_AND_CUSTODY_GOVERNANCE.md), [KEY_MATERIAL_ROTATION_REVOCATION_AND_RECOVERY_POLICY.md](../docs/security/KEY_MATERIAL_ROTATION_REVOCATION_AND_RECOVERY_POLICY.md) und [CONFIGURATION_SOURCE_OF_TRUTH_AND_SECRET_REFERENCE_MODEL.md](../docs/architecture/CONFIGURATION_SOURCE_OF_TRUTH_AND_SECRET_REFERENCE_MODEL.md). **Getrennte Dimensionen** (Decision Class · Lifecycle Status · Binding Level); keine kombinierten Pseudostatuswerte; keine ADR.
>
> **CO-WP-024-Deduplizierung (Nova GO WITH NOTES, Note 2):** Zwei ursprünglich registrierte Einträge wurden vor dem Commit entfernt, weil sie keine eigenständige normative Wirkung besaßen: (a) *Offline secret/key authorization* — die begrenzte, nicht wiederverwendbare Offline-Autorisierung ist bereits durch **DEC-S-314** abgedeckt, die zusätzliche Secret-/Key-/Consumer-Bindung durch **DEC-S-322/324**; keine Ersatz-Decision angelegt. (b) *Technology-Deferral* (Vault/KMS/HSM/TPM/PKI/Krypto/Secret-Store/Configuration usw.) — eine Decision allein dafür, dass **keine** Technologie ausgewählt wurde, ist unzulässig; die Deferral bleibt als Governance-Grenze in den Technology-Boundary-/Non-Goals-Abschnitten der drei Dokumente dokumentiert. Der uncommittete Bereich wurde daraufhin lückenlos von DEC-S-318 neu nummeriert (Endstand **DEC-S-331**); ältere Decision IDs unverändert. Machine-Credential-Lifecycle (DEC-S-90…105), Break-Glass (DEC-S-84/DEC-S-85/DEC-S-147) und Offline-Autorität (DEC-S-305/314) werden referenziert, nicht dupliziert.

| Decision ID | Topic | Decision Class | Lifecycle Status | Binding Level | Source | Owner | Notes |
| ----------- | ----- | -------------- | ---------------- | ------------- | ------ | ----- | ----- |
| DEC-S-318 | Secret vs configuration | governance-direction | accepted | binding-governance | CO-WP-024 | Nova | secret ≠ ordinary configuration; sensitive/secret configuration klassifiziert |
| DEC-S-319 | Secret reference in governed objects | security-context | accepted | binding-governance | CO-WP-024 | HM | Governte Objekte (config/blueprint/CorePack/logs/events/evidence) tragen Reference, nicht Value; reference ≠ value |
| DEC-S-320 | Secret identity/version/instances | governance-direction | accepted | binding-governance | CO-WP-024 | Nova | Logical identity/version/value revision/value+credential+lease+retrieval+distribution+injection+use instance getrennt |
| DEC-S-321 | Credential and authorization | security-context | accepted | binding-governance | CO-WP-024 | Nova | authentication material ≠ authorization material; possession ≠ authorization |
| DEC-S-322 | Retrieval/distribution/injection/use | security-context | accepted | binding-governance | CO-WP-024 | Nova | Getrennte Zustände; retrieved ≠ delivered ≠ injected ≠ consumed |
| DEC-S-323 | Vault as logical boundary | governance-direction | accepted | binding-governance | CO-WP-024 | Nova | Governte logische Schutz-/Autoritätsgrenze; kein Produkt; availability ≠ trust |
| DEC-S-324 | Secret/key/config authorities | security-context | accepted | binding-governance | CO-WP-024 | Nova | owner ≠ custodian ≠ user; retrieval ≠ use ≠ export; rotation ≠ reinstatement; backup operator ≠ recovery authority |
| DEC-S-325 | Key identity/material/custody | security-context | accepted | binding-governance | CO-WP-024 | Nova | key identity ≠ key material; custody ≠ use authority; private possession ≠ operation authorization |
| DEC-S-326 | Rotation completion | security-context | accepted | binding-governance | CO-WP-024 | Nova | Rotation/Revocation getrennt; complete erst nach Consumer-State-Assessment |
| DEC-S-327 | Revocation binding | security-context | accepted | binding-governance | CO-WP-024 | Nova | Revocation besitzt Identity Binding und Freshness; no local entry ≠ not revoked centrally |
| DEC-S-328 | Bootstrap/root/recovery/break-glass material | security-context | accepted | binding-governance | CO-WP-024 | HM | bounded/one-time; mandatory rotation/invalidation; keine dauerhafte Autorität |
| DEC-S-329 | Recovery vs reinstatement | security-context | accepted | binding-governance | CO-WP-024 | Nova | Recovery ≠ Reinstatement ≠ globaler Trust; Rollback reaktiviert kein widerrufenes/abgelaufenes/kompromittiertes Material |
| DEC-S-330 | CorePack/deployment secret boundary | security-context | accepted | binding-governance | CO-WP-024 | Nova | CorePack trust ≠ secret trust; deployment authorization ≠ secret-use authorization |
| DEC-S-331 | Configuration source of truth | governance-direction | accepted | binding-governance | CO-WP-024 | Nova | source of truth ≠ runtime state; applied ≠ desired verified; drift detected ≠ remediated |

## Data Classification, Retention and Redaction Decisions (CO-WP-025)

> Registriert über [DATA_CLASSIFICATION_AND_HANDLING_MODEL.md](../docs/governance/DATA_CLASSIFICATION_AND_HANDLING_MODEL.md), [DATA_RETENTION_DELETION_AND_PRESERVATION_POLICY.md](../docs/governance/DATA_RETENTION_DELETION_AND_PRESERVATION_POLICY.md) und [REDACTION_MINIMIZATION_AND_CONTROLLED_DISCLOSURE_POLICY.md](../docs/security/REDACTION_MINIMIZATION_AND_CONTROLLED_DISCLOSURE_POLICY.md). **Getrennte Dimensionen** (Decision Class · Lifecycle Status · Binding Level); keine kombinierten Pseudostatuswerte; keine ADR; **keine reine Technology-Deferral-Decision** (Deferral bleibt als Governance-Grenze in den Technology-Boundary-/Non-Goals-Abschnitten der drei Dokumente); Offline-Autorität (DEC-S-305/314) referenziert, nicht dupliziert. Konkretisiert DEC-P-08.

| Decision ID | Topic | Decision Class | Lifecycle Status | Binding Level | Source | Owner | Notes |
| ----------- | ----- | -------------- | ---------------- | ------------- | ------ | ----- | ----- |
| DEC-S-332 | Data classification boundary | governance-direction | accepted | binding-governance | CO-WP-025 | Nova | classification ≠ deployment profile/connectivity class/national-security; label ≠ proven compliance |
| DEC-S-333 | Unknown-classification handling | security-context | accepted | binding-governance | CO-WP-025 | Nova | fail-closed zur strengeren anwendbaren Handling-Grenze |
| DEC-S-334 | Classification identity/freshness | governance-direction | accepted | binding-governance | CO-WP-025 | Nova | Identity/Scope/Version/Freshness getrennt; materiale Änderung → Reassessment; reclassification erhält Historie |
| DEC-S-335 | Data authorities | security-context | accepted | binding-governance | CO-WP-025 | Nova | owner/steward/custodian/collection/use/disclosure/export/retention/hold/deletion/redaction getrennt |
| DEC-S-336 | Collection and minimization | governance-direction | accepted | binding-governance | CO-WP-025 | Nova | collection ≠ every later use; useful ≠ necessary; derived data ≠ frei von Source-Restriktionen |
| DEC-S-337 | Retention start/expiry | governance-direction | accepted | binding-governance | CO-WP-025 | HM | Retention beginnt an definiertem Start Event; expiry ≠ deletion authorization/completion |
| DEC-S-338 | Preservation hold | security-context | accepted | binding-governance | CO-WP-025 | HM | Hold und Retention getrennte Autoritäten; hold ≠ unrestricted access; neutraler Begriff, keine Rechtswirkung behauptet |
| DEC-S-339 | Deletion lifecycle | security-context | accepted | binding-governance | CO-WP-025 | Nova | request/authorization/execution/verification getrennt; primary deletion ≠ all copies; unknown ≠ deleted; logical ≠ destruction |
| DEC-S-340 | Redaction as derived view | security-context | accepted | binding-governance | CO-WP-025 | Nova | erzeugt gebundene Derived View, verändert Quelle nicht still; redacted ≠ disclosure-safe; masking/pseudonym/hash/aggregation ≠ anonymization |
| DEC-S-341 | Disclosure/export authority | security-context | accepted | binding-governance | CO-WP-025 | Nova | disclosure/export/publication getrennt von read/local access; classification-bound; data available ≠ disclosure authorized |
| DEC-S-342 | Secret-bearing data boundary | security-context | accepted | binding-governance | CO-WP-025 | Nova | an CO-WP-024 gebunden; Redaction ≠ Secret Removal; maskiertes Secret bleibt secret-bearing |
| DEC-S-343 | Evidence vs source retention | governance-direction | accepted | binding-governance | CO-WP-025 | Nova | evidence retention ≠ unbegrenzte source-data retention; source deletion ≠ evidence deletion |
| DEC-S-344 | Copies in scope | security-context | accepted | binding-governance | CO-WP-025 | Nova | copies/caches/replicas/backups/derived data bleiben im Retention-/Classification-Scope |

## Self-Protection, Degraded Mode and Recovery Decisions (CO-WP-026)

> Registriert über [SELF_PROTECTION_AND_CONTROL_PLANE_SAFETY_MODEL.md](../docs/security/SELF_PROTECTION_AND_CONTROL_PLANE_SAFETY_MODEL.md), [DEGRADED_MODE_AND_CAPABILITY_RESTRICTION_MODEL.md](../docs/architecture/DEGRADED_MODE_AND_CAPABILITY_RESTRICTION_MODEL.md) und [RECOVERY_MODE_AUTHORITY_AND_CONTROLLED_RESTORATION_POLICY.md](../docs/governance/RECOVERY_MODE_AUTHORITY_AND_CONTROLLED_RESTORATION_POLICY.md). **Getrennte Dimensionen** (Decision Class · Lifecycle Status · Binding Level); keine kombinierten Pseudostatuswerte; keine ADR; **keine Technology-Deferral-Decision** (Deferral bleibt Governance-Grenze in den Technology-Boundary-/Non-Goals-Abschnitten). Nicht dupliziert, sondern referenziert: DEC-S-316 (Restricted/Degraded Operation benannt/begrenzt/reviewbar), DEC-S-305/314 (Offline-Autorität), DEC-S-329 (Recovery ≠ Reinstatement), DEC-S-84/DEC-S-85/DEC-S-147 (Break-Glass). Adressiert RISK-11 (Self-Dependency).

| Decision ID | Topic | Decision Class | Lifecycle Status | Binding Level | Source | Owner | Notes |
| ----------- | ----- | -------------- | ---------------- | ------------- | ------ | ----- | ----- |
| DEC-S-345 | Governability vs reachability | governance-direction | accepted | binding-governance | CO-WP-026 | Nova | governability ≠ technische Erreichbarkeit; process running ≠ platform governable |
| DEC-S-346 | Self-protection scope | governance-direction | accepted | binding-governance | CO-WP-026 | Nova | Betrifft primär den CoreOps Control Plane; ≠ Schutz jedes verwalteten Assets; control-plane health ≠ managed-system health |
| DEC-S-347 | Operational modes and capability matrix | governance-direction | accepted | binding-governance | CO-WP-026 | Nova | Zehn explizite Modes mit verbindlicher Capability Restriction Matrix; Modes capability-bounded |
| DEC-S-348 | Protective conditions | security-context | accepted | binding-governance | CO-WP-026 | HM | Erweitern keine Autorität; trigger ≠ compromise proven; absence of trigger ≠ safety |
| DEC-S-349 | Read-only mode | security-context | accepted | binding-governance | CO-WP-026 | Nova | ≠ garantierte Abwesenheit von Side Effects; ≠ Secret Disclosure; read-only UI ≠ read-only platform |
| DEC-S-350 | Containment vs recovery | security-context | accepted | binding-governance | CO-WP-026 | Nova | Containment ≠ Recovery; containment applied ≠ compromise removed; containment release ≠ recovery exit |
| DEC-S-351 | Recovery mode boundary | governance-direction | accepted | binding-governance | CO-WP-026 | Nova | Recovery Mode ≠ ordinary mode ≠ backup restore ≠ rollback; service restored ≠ authority restored |
| DEC-S-352 | Recovery authority | security-context | accepted | binding-governance | CO-WP-026 | HM | Eigenständig und begrenzt; ≠ normale Policy-/Execution-Autorität; ≠ unrestricted admin; operator ≠ approver; offline/break-glass erweitern sie nicht |
| DEC-S-353 | Recovery input reassessment | security-context | accepted | binding-governance | CO-WP-026 | Nova | Aktuelle Identity-/Provenance-/Integrity-/Trust-/Revocation-/Compatibility-/Freshness-/Target-Binding-Bewertung; previously trusted ≠ currently trusted |
| DEC-S-354 | Recovery exit | security-context | accepted | binding-governance | CO-WP-026 | HM | Benötigt Reassessment, Verification und Reconciliation; kann in guarded/restricted/degraded austreten (nicht zwingend normal) |
| DEC-S-355 | Partial/unknown recovery outcomes | security-context | accepted | binding-governance | CO-WP-026 | Nova | Bleiben sichtbar und blockieren unsichere Wiederholung; recovery aborted ≠ prior state restored |
| DEC-S-356 | Evidence/telemetry unavailability | security-context | accepted | binding-governance | CO-WP-026 | Nova | Ausfall ≠ gesunder Zustand/keine Operation; kann privilegierte Fähigkeiten einschränken |
| DEC-S-357 | Unknown operational state | security-context | accepted | binding-governance | CO-WP-026 | Nova | Fail-closed in den restriktiveren Mode; unknown ≠ normal/safe |

## UX Information Architecture and Dashboard Decisions (CO-WP-027)

> Registriert über [UX_INFORMATION_ARCHITECTURE_AND_NAVIGATION_MODEL.md](../docs/architecture/UX_INFORMATION_ARCHITECTURE_AND_NAVIGATION_MODEL.md), [DASHBOARD_INFORMATION_HIERARCHY_AND_STATE_PRESENTATION_MODEL.md](../docs/architecture/DASHBOARD_INFORMATION_HIERARCHY_AND_STATE_PRESENTATION_MODEL.md) und [UX_ACTION_SAFETY_ACCESSIBILITY_AND_DISCLOSURE_POLICY.md](../docs/security/UX_ACTION_SAFETY_ACCESSIBILITY_AND_DISCLOSURE_POLICY.md). **Getrennte Dimensionen** (Decision Class · Lifecycle Status · Binding Level); keine kombinierten Pseudostatuswerte; keine ADR; **keine Technology-Deferral-Decision** und **keine CDS-Decision** (Technologie-Deferral bleibt Governance-Grenze in den Technology-Boundary-/Non-Goals-Abschnitten; die CDS-Grenze ist bereits über den nicht-aktivierenden Gate-Hinweis in Queue/Brain governt). Nicht dupliziert, sondern referenziert: DEC-S-68 (Experience-Modul löst privilegierte Ausführung nicht direkt aus), DEC-S-42 (Summary überschreibt keine autoritative Quelle), DEC-P-06 (fehlende Daten ≠ gesund), DEC-P-03/DEC-S-38/DEC-S-39 (DE/EN, kanonische Sprache, Übersetzungsparität), DEC-S-340 (Redaction als Derived View), DEC-S-349 (read-only ≠ side-effect-free), DEC-S-316 (Degraded benannt/begrenzt/reviewbar), DEC-S-84/DEC-S-85/DEC-S-147 (Break-Glass), DEC-S-254 (Dashboard-Technologie deferred), DEC-G-04 (Preview vor Execute). Adressiert RISK-12 und RISK-106 darstellungsseitig.

| Decision ID | Topic | Decision Class | Lifecycle Status | Binding Level | Source | Owner | Notes |
| ----------- | ----- | -------------- | ---------------- | ------------- | ------ | ----- | ----- |
| DEC-S-358 | Information area traceability | architecture-context | accepted | binding-governance | CO-WP-027 | Nova | Jeder Top-Level-Informationsbereich führt auf bestehende Capability/Modul/Domäne zurück; navigation ≠ domain ownership; Domain Lenses sind keine parallele Autorität |
| DEC-S-359 | Presentation context binding | governance-direction | accepted | binding-governance | CO-WP-027 | Nova | Acht bestehende RBAC-Scopes als Presentation Context; explizit, sichtbar, programmatisch bestimmbar; kein stilles Ausweiten; unknown → fail-closed auf engeren Scope |
| DEC-S-360 | Dashboard representation boundary | governance-direction | accepted | binding-governance | CO-WP-027 | Nova | dashboard representation ≠ authoritative domain state; kein zweites System of Record; Zusammenfassung darf priorisieren, aber keine Dimension löschen; konkretisiert DEC-S-42 |
| DEC-S-361 | Status presentation dimensions | architecture-context | accepted | binding-governance | CO-WP-027 | Nova | Elf Dimensionen getrennt darstell-/filterbar; kein globaler Health-Boolean, kein normativer Aggregat-Score; Ampel/Icon/Farbe/Position sind Darstellungsform, keine Statussemantik |
| DEC-S-362 | Availability, permission and unknown distinction | security-context | accepted | binding-governance | CO-WP-027 | Nova | capability unavailable ≠ permission denied ≠ unknown ≠ restricted by mode; hidden ≠ nonexistent; Begründungstiefe disclosure-gebunden, aber keine Falschaussage „nicht vorhanden" |
| DEC-S-363 | Simple/Expert presentation boundary | governance-direction | accepted | binding-governance | CO-WP-027 | HM | Verändert nur Dichte/Darstellung, nie das Berechtigungsergebnis; aktiver Modus sichtbar und programmatisch bestimmbar; fehlende Präferenz → sicherer expliziter Fallback; Expert ≠ Break-Glass |
| DEC-S-364 | Dangerous-action presentation chain | security-context | accepted | binding-governance | CO-WP-027 | HM | Zehnstufiger Pfad nicht kollabierbar; UI confirmation ≠ approval record; preview ≠ execution; Pflichtkommunikation inkl. unknown; konkretisiert DEC-S-68/DEC-G-04 |
| DEC-S-365 | Accessibility and bilingual design requirement | governance-direction | accepted | binding-governance | CO-WP-027 | HM | Tastatur, Fokus, Nicht-nur-Farbe, Textäquivalente, klare Sprache, DE/EN-Textexpansion als Designanforderung; **keine** WCAG-/Validierungs-/Zertifizierungsaussage; keine Accessibility-Evidenz erzeugt |

## Test Strategy, Fixture and Integration Lab Decisions (CO-WP-028)

> Registriert über [FOUNDATION_TEST_STRATEGY_AND_VALIDATION_MODEL.md](../docs/testing/FOUNDATION_TEST_STRATEGY_AND_VALIDATION_MODEL.md), [SYNTHETIC_FIXTURE_AND_TEST_DATA_GOVERNANCE.md](../docs/testing/SYNTHETIC_FIXTURE_AND_TEST_DATA_GOVERNANCE.md) und [INTEGRATION_LAB_SCENARIO_AND_EVIDENCE_MODEL.md](../docs/testing/INTEGRATION_LAB_SCENARIO_AND_EVIDENCE_MODEL.md). **Getrennte Dimensionen** (Decision Class · Lifecycle Status · Binding Level); keine kombinierten Pseudostatuswerte; keine ADR; **keine Technology-Deferral-Decision** (die Technologiegrenze bleibt Governance-Grenze der Non-Goals) und **keine CDS-Decision** (die CDS-Grenze ist über den nicht-aktivierenden Gate-Hinweis governt). Diese Entscheidungen betreffen **Test-Governance**, nicht Testausführung: `test strategy documented ≠ tests implemented ≠ tests executed`. Nicht dupliziert, sondern referenziert: DEC-S-153…168 (Integration Contract, sechs Capability-Dimensionen), DEC-S-220…236 (Event/Audit/Evidence, Evidence-Autorität), DEC-S-186…203 (Migration), DEC-S-237…254 (Telemetry), DEC-S-274…288 (Deployment), DEC-S-316 (Degraded benannt/begrenzt/reviewbar), DEC-S-345…357 (Self-Protection/Recovery), DEC-S-358…365 (UX/Dashboard/Accessibility), DEC-P-06 (fehlende Daten ≠ gesund), DEC-G-04 (Preview vor Execute). Adressiert die 21 auf `CO-WP-028` gerichteten Risiken **teststrategieseitig**; **kein** Risiko wird dadurch geschlossen.

| Decision ID | Topic | Decision Class | Lifecycle Status | Binding Level | Source | Owner | Notes |
| ----------- | ----- | -------------- | ---------------- | ------------- | ------ | ----- | ----- |
| DEC-S-366 | Test validation claim boundary | security-context | accepted | binding-governance | CO-WP-028 | Nova | Test-Evidenz ist eine Evidence-Klasse **innerhalb** des bestehenden Evidence-/Audit-Modells (MOD-EVD-001), keine zweite Autorität; test evidence ≠ operational authority ≠ approval; validation ≠ support; das **Claim Boundary Set** (`planned ≠ implemented ≠ executed ≠ passed ≠ requirement universally satisfied`; `fixture passed ≠ production validated`) ist eine Menge unabhängiger Nicht-Implikationen und **keine** universelle Reifeleiter (`claim boundary set ≠ universal maturity ladder`); keine seiner Grenzen darf in einer Aussage überschritten werden |
| DEC-S-367 | Foundation test layer taxonomy | architecture-context | accepted | binding-governance | CO-WP-028 | Nova | Zehn aus CoreOps abgeleitete Ebenen `TL-1`…`TL-10`, je mit deklariertem Subject, Authoritative Input, Evidenz, Failure Meaning und ausdrücklich Nicht-Belegbarem; **keine** Testpyramide, keine Mengenverteilung; test level ≠ authority level |
| DEC-S-368 | Test case traceability contract | architecture-context | accepted | binding-governance | CO-WP-028 | Nova | 18 konzeptionelle Mindestfelder; jeder Fall referenziert Contract/Requirement/Invariant und, sofern zutreffend, Decision/Risk/Threat; Identity und Revision getrennt; test case references authority ≠ test case becomes authority |
| DEC-S-369 | Test outcome vocabulary scope | governance-direction | accepted | binding-governance | CO-WP-028 | Nova | Sechs Ergebniszustände (`not run`, `passed`, `failed`, `blocked`, `inconclusive`, `not applicable`) **ausschließlich** für Testausführung/-evidenz; **kein** globales CoreOps-Statusmodell; `partially passed`, `stale`/`expired` und `error` geprüft und bewusst verworfen; not run ≠ passed, blocked ≠ failed, inconclusive ≠ passed, not applicable ≠ unknown |
| DEC-S-370 | Negative and fail-closed test primacy | security-context | accepted | binding-governance | CO-WP-028 | HM | Negativszenarien sind erstklassig; `passed` nur bei **beobachtetem geschütztem Verhalten**; an error message appeared ≠ protected behavior observed; 17 verpflichtende Negativfamilien; fehlende Beobachtung des Ausbleibens einer Wirkung → `inconclusive` |
| DEC-S-371 | Synthetic fixture and test-data governance | security-context | accepted | binding-governance | CO-WP-028 | HM | Synthetisch als Default; Identity, Revision, Provenance und Expected Outcome explizit; **keine** realen Secrets, wiederverwendbaren Credentials, realen privaten Hostnamen/Domains/Netzbereiche oder unredigierten personenbezogenen Daten; Testdaten bleiben klassifizierte Daten unter CO-WP-024/025; synthetic ≠ safe by definition; masked secret bleibt secret-bearing; fixture correctness ≠ system correctness; fixture representativeness ≠ production equivalence |
| DEC-S-372 | Integration Lab and simulation boundary | security-context | accepted | binding-governance | CO-WP-028 | HM | Logisches, **non-production**, isoliertes, verwerfbares, selbst-hostbares, offline-fähiges Lab ohne Produktionsreichweite; lab role ≠ production authority; lab target ≠ production target; lab credential ≠ production credential; lab approval ≠ production deployment authorization; Fidelity-Deklaration je Test Double verpflichtend; simulator pass ≠ real provider validation; integration-lab success ≠ production readiness |
| DEC-S-373 | Multidimensional test coverage model | governance-direction | accepted | binding-governance | CO-WP-028 | Nova | 14 Coverage-Dimensionen; **keine** einzelne Prozentzahl als alleiniges Maß; unbekannte Coverage bleibt explizit und wird nie als `0` oder abgedeckt geführt; coverage metric ≠ quality; 100% of declared subset ≠ 100% of Foundation; aktueller Stand in allen Dimensionen `not measured` |
...
- Foundation Decisions (Sektion „Open Foundation Decisions"): 21 — davon offen 9, `clarified` 7, `binding-governance` 4, `verified` 1 (Statusabgleich `HM-4` in `CO-WP-031`)
- ADR Candidates: 32 (30 Concept + 2 Foundation)
- Deferred Decisions: 6
- Non-Goals: 12

**CO-WP-003-Auflösungen (durch den Human-Maintainer-Commit `fcee985` bindend geworden; Statusabgleich `HM-4` in `CO-WP-031`):** DEC-O-02 `clarified`, DEC-O-03 `clarified`, DEC-O-04 `binding-governance`, DEC-O-10 `clarified`, DEC-O-11 `clarified`, DEC-O-16 `verified`.

**CO-WP-004-Auflösungen (durch den Human-Maintainer-Commit `94d69d5` bindend geworden; Statusabgleich `HM-4` in `CO-WP-031`):** DEC-O-12 Herstellersupport-Grenze `clarified` (CCR-12), DEC-O-17 Capability Matrix `clarified`, DEC-O-18 Observe Support Boundary `clarified`, DEC-O-19 drei Statusdimensionen `binding-governance`, DEC-O-20 Support-Evidence `binding-governance`, DEC-O-21 Herstellerlisten ≠ Support `binding-governance`.
...
**CO-WP-028-Registrierungen:** 8 Test-Governance-Entscheidungen (DEC-S-366…373), **getrennte Dimensionen**: Test-Evidenz als Evidence-Klasse im bestehenden Modell statt zweiter Autorität (test evidence ≠ operational authority ≠ approval; validation ≠ support; support ≠ implementation) mit einem **Claim Boundary Set** unabhängiger Nicht-Implikationen statt einer universellen Reifeleiter (`claim boundary set ≠ universal maturity ladder`; nur `planned → implemented → executed → result` ist eine echte Progression; `test passed ≠ requirement universally satisfied`; `fixture passed ≠ production validated`; `no failing test ≠ absence of defect`; `support`, `production readiness`, `security validation`, `accessibility validation`, `fixture representativeness` und `operational validation` bleiben eigenständige Dimensionen mit eigener Autorität und sind **keine** Sprossen); zehn aus CoreOps abgeleitete Testebenen `TL-1`…`TL-10` statt einer Testpyramide (test level ≠ authority level); Test-Case-Traceability über 18 Mindestfelder (test case references authority ≠ test case becomes authority); sechs Ergebniszustände **ausschließlich** für Testausführung/-evidenz und ausdrücklich **kein** globales Statusmodell (`partially passed`/`stale`/`error` geprüft und verworfen; not run ≠ passed, blocked ≠ failed, inconclusive ≠ passed, not applicable ≠ unknown); Negativ-/Fail-Closed-Szenarien erstklassig mit `passed` nur bei beobachtetem geschütztem Verhalten (an error message appeared ≠ protected behavior observed); synthetische Fixtures mit expliziter Identity/Revision/Provenance/Expected Outcome und ohne reale Secrets, Credentials, private Hostnamen oder unredigierte personenbezogene Daten (synthetic ≠ safe by definition; test data ≠ unclassified data; masked secret bleibt secret-bearing); Integration Lab als non-production, isoliert, verwerfbar, ohne Produktionsreichweite mit verpflichtender Test-Double-Fidelity (lab target/credential/approval ≠ Produktionsäquivalent; simulator pass ≠ real provider validation; integration-lab success ≠ production readiness); mehrdimensionale Coverage ohne alleinige Prozentzahl (coverage metric ≠ quality; unbekannte Coverage bleibt explizit). **Keine Technology-Deferral-Decision** und **keine CDS-Decision**. DEC-S-153…168, DEC-S-186…203, DEC-S-220…236, DEC-S-237…254, DEC-S-274…288, DEC-S-316, DEC-S-345…357, DEC-S-358…365, DEC-P-06 und DEC-G-04 referenziert, nicht dupliziert. Adressiert die 21 auf `CO-WP-028` gerichteten Risiken teststrategieseitig; **kein** Risiko geschlossen. Keine Technologieauswahl; keine ausgeführten Tests; keine ADR. `DEC-S-01…37` bleiben unverändert.

**CO-WP-027-Registrierungen:** 8 UX-Information-Architecture-/Dashboard-/Action-Safety-Entscheidungen (DEC-S-358…365), **getrennte Dimensionen**: Informationsbereiche traceable auf bestehende Capability/Modul/Domäne (navigation ≠ domain ownership; Domain Lenses ≠ parallele Autorität); Presentation Context auf den acht bestehenden RBAC-Scopes, explizit/sichtbar/programmatisch bestimmbar (kein stilles Ausweiten; unknown → fail-closed auf engeren Scope); Dashboard-Darstellung ≠ autoritativer Domänenzustand und kein zweites System of Record (Zusammenfassung darf priorisieren, aber keine Dimension löschen; summary ≠ completeness); elf Statusdimensionen getrennt (kein globaler Health-Boolean, kein normativer Aggregat-Score; Ampel/Farbe/Icon/Position = Darstellungsform, keine Statussemantik; unknown ≠ healthy, stale ≠ current, unverified ≠ verified, partial ≠ complete, degraded ≠ failed, conflicted ≠ resolved); capability unavailable ≠ permission denied ≠ unknown ≠ restricted by mode und hidden ≠ nonexistent (Begründungstiefe disclosure-gebunden, aber keine Falschaussage); Simple/Expert nur Dichte/Darstellung, nie das Berechtigungsergebnis (aktiver Modus sichtbar/programmatisch bestimmbar; fehlende Präferenz → sicherer expliziter Fallback; Expert ≠ Break-Glass); zehnstufiger Dangerous-Action-Pfad nicht kollabierbar (UI confirmation ≠ approval record; preview ≠ execution; policy permit ≠ approval ≠ execution authorization; executed ≠ successful ≠ verified; partial ≠ success; outcome unknown ≠ failed); Accessibility und DE/EN als Designanforderung **ohne** WCAG-/Validierungs-/Zertifizierungsaussage. **Keine Technology-Deferral-Decision** und **keine CDS-Decision** (Technologie-Deferral bleibt Governance-Grenze in Technology-Boundary/Non-Goals; die CDS-Grenze ist bereits über den nicht-aktivierenden Gate-Hinweis governt). DEC-S-68 (Experience-Grenze), DEC-S-42 (Summary ≠ autoritative Quelle), DEC-P-06 (fehlende Daten ≠ gesund), DEC-P-03/DEC-S-38/DEC-S-39 (DE/EN), DEC-S-340 (Redaction als Derived View), DEC-S-349 (read-only ≠ side-effect-free), DEC-S-316, DEC-S-84/DEC-S-85/DEC-S-147 (Break-Glass), DEC-S-254 und DEC-G-04 referenziert, nicht dupliziert. Adressiert RISK-12 und RISK-106 darstellungsseitig. Keine Technologieauswahl; keine CDS-Adoption; kein CDS-Pilot; keine ADR. `DEC-S-01…37` bleiben unverändert.

**CO-WP-026-Registrierungen:** 13 Self-Protection-/Degraded-Mode-/Recovery-Entscheidungen (DEC-S-345…357), **getrennte Dimensionen**: Governability ≠ technische Erreichbarkeit (process running ≠ platform governable); Self-Protection betrifft primär den Control Plane (≠ Schutz jedes verwalteten Assets; control-plane health ≠ managed-system health); zehn Operational Modes mit verbindlicher Capability Restriction Matrix; Protective Conditions erweitern keine Autorität (trigger ≠ compromise proven; absence ≠ safety); Read-only ≠ garantierte Abwesenheit von Side Effects/Secret Disclosure; Containment ≠ Recovery (containment release ≠ recovery exit); Recovery Mode ≠ ordinary mode ≠ backup restore ≠ rollback (service restored ≠ authority restored); Recovery Authority eigenständig/begrenzt (≠ normale Policy-/Execution-Autorität; operator ≠ approver); Recovery Inputs mit aktueller Identity-/Provenance-/Integrity-/Trust-/Revocation-/Compatibility-/Freshness-/Target-Binding-Bewertung (previously trusted ≠ currently trusted); Recovery Exit benötigt Reassessment/Verification/Reconciliation (kann in guarded/restricted/degraded austreten); Partial/Unknown Recovery Outcomes sichtbar und blockieren unsichere Wiederholung; Evidence-/Telemetry-Ausfall ≠ gesunder Zustand (kann privilegierte Fähigkeiten einschränken); Unknown Operational State fail-closed. **Keine Technology-Deferral-Decision**; DEC-S-316 (Degraded benannt/begrenzt/reviewbar), DEC-S-305/314 (Offline-Autorität), DEC-S-329 (Recovery ≠ Reinstatement) und DEC-S-84/DEC-S-85/DEC-S-147 (Break-Glass) referenziert, nicht dupliziert. Adressiert RISK-11 (Self-Dependency). Keine Technologieauswahl; keine ADR. `DEC-S-01…37` bleiben unverändert.

**CO-WP-025-Registrierungen:** 13 Data-Classification-/Retention-/Redaction-Entscheidungen (DEC-S-332…344), **getrennte Dimensionen**: Data Classification ≠ Deployment Profile/Connectivity Class/National-Security (label ≠ proven compliance); Unknown-Classification fail-closed zur strengeren Grenze; Classification Identity/Scope/Version/Freshness getrennt (materiale Änderung → Reassessment; reclassification erhält Historie); getrennte Daten-Autoritäten (owner/steward/custodian/collection/use/disclosure/export/retention/hold/deletion/redaction); Collection ≠ every later use (useful ≠ necessary; derived ≠ frei von Source-Restriktionen); Retention beginnt an definiertem Start Event (expiry ≠ deletion authorization/completion); Preservation Hold und Retention getrennte Autoritäten (hold ≠ unrestricted access; neutraler Begriff, keine Rechtswirkung); Deletion request/authorization/execution/verification getrennt (primary deletion ≠ all copies; unknown ≠ deleted; logical ≠ destruction); Redaction erzeugt gebundene Derived View (verändert Quelle nicht still; redacted ≠ disclosure-safe; masking/pseudonym/hash/aggregation ≠ anonymization); Disclosure/Export/Publication getrennt von read/local access (classification-bound; data available ≠ disclosure authorized); Secret-bearing Data an CO-WP-024 gebunden (Redaction ≠ Secret Removal; maskiertes Secret bleibt secret-bearing); Evidence Retention ≠ unbegrenzte Source-Data-Retention; Copies/Caches/Replicas/Backups/Derived Data bleiben im Scope. **Keine reine Technology-Deferral-Decision** (Deferral als Governance-Grenze dokumentiert); Offline-Autorität (DEC-S-305/314) referenziert, nicht dupliziert. Konkretisiert DEC-P-08. Keine Technologieauswahl; keine ADR; keine Wiederholung bestehender Cross-Foundation-Invarianten. `DEC-S-01…37` bleiben unverändert.

**CO-WP-024-Registrierungen:** 14 Secret-/Configuration-Vault-/Key-Custody-Entscheidungen (DEC-S-318…331 nach Nova-GO-WITH-NOTES-Deduplizierung, Note 2; ursprünglich 16), **getrennte Dimensionen**: secret ≠ ordinary configuration (sensitive/secret configuration klassifiziert); governte Objekte tragen Secret Reference statt Value (reference ≠ value); Secret Identity/Version/Value-Revision/Instances getrennt; authentication material ≠ authorization material (possession ≠ authorization); Retrieval/Distribution/Injection/Use getrennte Zustände; Vault als logische Governance-Grenze (kein Produkt; availability ≠ trust); getrennte Secret-/Key-/Config-Autoritäten (owner ≠ custodian ≠ user; retrieval ≠ use ≠ export; rotation ≠ reinstatement; backup operator ≠ recovery authority); key identity ≠ key material ≠ custody (custody ≠ use authority); Rotation vollständig erst nach Consumer-State-Assessment (Rotation/Revocation getrennt); Revocation mit Identity Binding und Freshness; Bootstrap/Root/Recovery/Break-Glass-Material bounded/one-time (keine dauerhafte Autorität); Recovery ≠ Reinstatement ≠ globaler Trust (Rollback reaktiviert kein widerrufenes/abgelaufenes/kompromittiertes Material); CorePack Trust ≠ Secret Trust und Deployment Authorization ≠ Secret-Use Authorization; Configuration Source of Truth ≠ Runtime State (applied ≠ desired verified; drift detected ≠ remediated). **Entfernt vor Commit (keine eigenständige normative Wirkung):** Offline-Secret-/Key-Authorization (durch DEC-S-314 + DEC-S-322/324 abgedeckt) und die reine Technology-Deferral-Decision (unzulässig; Deferral bleibt als Governance-Grenze in den Technology-Boundary-/Non-Goals-Abschnitten dokumentiert). Keine Technologieauswahl; keine ADR; keine Wiederholung bestehender Cross-Foundation-Invarianten. `DEC-S-01…37` bleiben unverändert.

**CO-WP-023-Registrierungen:** 14 Restricted-Operation-/Offline-Distribution-/CorePack-Entscheidungen (DEC-S-304…317), **getrennte Dimensionen**: Operational Connectivity Classes (connected/restricted-connected/intermittently-connected/isolated/air-gapped/recovery-only) getrennte Betriebsbedingungen (keine Klassifiziertnetz-Eignung); Offline Operation erweitert zentrale/lokale Autorität nicht automatisch; CorePack als governte Distributionseinheit (≠ Domain Pack/Artifact/Deployment Blueprint/Backup/Evidence Package); CorePack Identity/Version/Revision/Assembly-/Transfer-/Import-/Activation-Instance getrennt; Transfer/Receipt/Import/Trust/Approval/Activation getrennte Zustände; Contents erben Trust/Validation/Compatibility nicht vom Container; Target Binding durch Transfer/Import/Activation erhalten (nicht durch Rename ersetzbar); Quarantine Release ≠ Activation Authorization; Delta Activation erfordert bestätigte exakte Ausgangsrevision; Delayed Revocation bleibt explizit (kann Activation beschränken/blockieren); Offline Authorization action-/target-/scope-/version-/purpose-/time-bound und nicht wiederverwendbar; Rollback erfordert aktuelle Trust-/Revocation-/Compatibility-/Recovery-Bewertung; Restricted/Degraded Operation benannt/begrenzt/zurechenbar/reviewbar; CorePack-Format-/Manifest-/Installer-/Update-/Transfer-/Hash-/Signing-/Trust-Anchor-/Encryption-/Reconciliation-Technologie `deferred`. Keine Technologieauswahl; keine ADR; keine Wiederholung bestehender Cross-Foundation-Invarianten. `DEC-S-01…37` bleiben unverändert.

**CO-WP-022-Registrierungen:** 15 Artifact-Trust-/Supply-Chain-Entscheidungen (DEC-S-289…303), **getrennte Dimensionen**: Artifact Identity stabil (≠ file name/repo path/alias); Version/Revision/Build-/Distribution-/Deployment-Instance getrennt; Mutable Alias nicht als finale privilegierte Deployment-Bindung; Source/Producer/Builder/Distributor/Repository-Operator/Validator/Trust-Owner getrennt; Provenance/Integrity/Validation/Trust/Support/Compatibility getrennt; SBOM Availability/Freshness/Completeness/Accuracy/Validation getrennt; Component Identity nicht durch Name/Version-Label allein; Vulnerability Reference ≠ automatische Exploitability; Trust Decision use-/target-/scope-/version-/time-bound (≠ Execution Authorization); Quarantine Release ≠ Deployment Authorization; Withdrawal/Revocation/Repository-Removal/Support-Withdrawal getrennt; Revocation blockiert neues Deployment außer bei governter Exception; Reinstatement erhält Historie (≠ globaler Trust); Offline Artifact Transfer mit Provenance/Integrität/Target-Binding/gebundenem Trust/expliziter Import-Governance; Registry-/Package-/SBOM-/Hash-/Signing-/Trust-Anchor-/Transparency-/Scanner-/Build-/Dependency-Resolution-Technologie `deferred`. Keine Technologieauswahl; keine ADR; keine Wiederholung bestehender Cross-Foundation-Invarianten. `DEC-S-01…37` bleiben unverändert.

**CO-WP-021-Registrierungen:** 15 Deployment-Control-Plane-Entscheidungen (DEC-S-274…288), **getrennte Dimensionen**: Deployment Control Plane als Governance-/Koordinationsgrenze (≠ Runtime); Blueprint Identity stabil (≠ file name/repo path/product version); Blueprint/Intent/Plan/Approval/Execution Authorization/Execution/Verification/Closure getrennt; dynamische Topology-Selektion → begrenzter Target-Set-Snapshot; Target-Set-Approval-Re-Evaluation nach materieller Änderung; Parameter/Overlays erhalten Provenance, schwächen Security nicht still; Artifact Availability ≠ Trust/Integrität/Compatibility/Authorization; Execution ≠ desired-state verification; Waves mit expliziter Expansion-Entscheidung; Partial/Unknown Per-Target-Results sichtbar/blockieren unsafe Retry; Cancellation ≠ Abwesenheit von Nebenwirkungen; Rollback mit gebundener Autorität + Verifikationsevidenz; Machine Principals imitieren keine Human Approval/Manual Authority; Offline Deployment mit Provenance/Integrität/Target-Binding/gebundener Authorization/expliziter Aktivierung; Deployment-Engine-/Orchestrator-/Pipeline-/Blueprint-Format-/Schema-/Agent-/Registry-/Rollback-Technologie `deferred`. Keine Technologieauswahl; keine ADR; keine Wiederholung bereits registrierter Invarianten. `DEC-S-01…37` bleiben unverändert.
...
> **Referenz-Korrekturhinweis (CO-WP-029):** Drei Prosa-Referenzen in diesem Index bezeichneten **DEC-S-88** fälschlich als Break-Glass-Entscheidung (CO-WP-024-Deduplizierungsnotiz sowie zwei CO-WP-026-Registrierungsabsätze). **DEC-S-88** ist autoritativ *Session technology* (`architecture-context` · `deferred` · `non-binding` · CO-WP-009) und bleibt inhaltlich **unverändert**. Die drei Referenzen wurden auf die tatsächlichen Break-Glass-Entscheidungen **DEC-S-84 / DEC-S-85 / DEC-S-147** korrigiert — dieselbe Schreibweise, die die CO-WP-027-Registrierung bereits verwendet. Rein referenzielle Korrektur: keine Decision umbenannt, umnummeriert, im Status verändert oder neu angelegt. Ebenfalls mechanisch korrigiert: die Notiz zu **DEC-O-17** nannte weiterhin „74 Capabilities"; autoritativ sind **94 Capabilities** (Zählkorrektur CO-WP-004E, siehe [FOUNDATION_CAPABILITY_MATRIX.md](../docs/architecture/FOUNDATION_CAPABILITY_MATRIX.md)). Details: [CROSS_DOCUMENT_CONSISTENCY_AND_ADR_CANDIDATE_REVIEW.md](../project-brain/CROSS_DOCUMENT_CONSISTENCY_AND_ADR_CANDIDATE_REVIEW.md).
