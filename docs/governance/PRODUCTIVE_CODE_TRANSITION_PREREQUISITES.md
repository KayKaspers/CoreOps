...
**Lizenzierung und `A-10`.** Die `A-9`-Policy kann **in Kraft** sein, während `A-10` **offen** bleibt. Eine **erste konkrete** Drittzulassung kann jedoch **nicht** abgeschlossen werden, solange die anwendbare Veröffentlichungs-/Lizenzdisposition (§13.3, §13.4) nicht ausreicht, um das Lizenzkriterium (Nr. 4) zu bewerten. `A-9 erfüllt != A-10 erfüllt`; `A-10` wird durch diesen Abschnitt **nicht** disponiert und bleibt **offen**.
...
**Bilanz Gate A: 10 von 14 erfüllt, 0 teilweise, 4 offen. Gate A ist nicht passiert.** Offen bleiben genau vier Punkte: `A-10`, `A-11`, `A-13` und `A-14`.
