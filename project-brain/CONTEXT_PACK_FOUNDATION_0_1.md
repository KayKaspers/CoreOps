...
- **Governance-Gates (noch nicht erteilt):** Observe-Entry `HM-O1` · `CO-WP-032` · Implementierung · Zielzugriff. — **Erteilt und abgeschlossen:** Foundation-Phasenabschluss `HM-F1` (`APPROVED / COMPLETE`).
